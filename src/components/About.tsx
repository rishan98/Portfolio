...
const About: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Node.js, Express, Python, and database design"
    },
    {
    ...
    },
    {
      ...
      description: "Fast, scalable, and maintainable code"
    }
  ];
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <p>
                I specialize in JavaScript/TypeScript ecosystems, with deep knowledge of 
                React, Node.js, and modern development practices. I'm always learning new 
          ...
          >
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-primary-400 font-semibold">5+ Years</span>
              </div>
              <div className="flex justify-between items-center">
